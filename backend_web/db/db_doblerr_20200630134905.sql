...
CREATE TABLE `app_promotion` (
  ...
  `url_nw` varchar(250) DEFAULT NULL,
  `url_design` varchar(250) DEFAULT NULL,
...
insert  into `app_promotion_user`(`processflag`,`insert_platform`,`insert_user`,`insert_date`,`update_platform`,`update_user`,`update_date`,`delete_platform`,`delete_user`,`delete_date`,`cru_csvnote`,`is_erpsent`,`is_enabled`,`i`,`id`,`code_erp`,`description`,`phone1`,`email`,`birthdate`,`name1`,`name2`,`id_gender`,`m1`,`m2`,`m3`,`m4`,`m5`,`code_cache`) values (NULL,'1',NULL,'2020-06-30 11:46:23',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','1',NULL,1,NULL,NULL,'123474128','e3ac@ya.com',NULL,'Eledu',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);

/*Table structure for table `app_promotions_susbscribers` */

DROP TABLE IF EXISTS `app_promotions_susbscribers`;

CREATE TABLE `app_promotions_susbscribers` (
  `processflag` varchar(5) DEFAULT NULL,
  `insert_platform` varchar(3) DEFAULT '1',
  `insert_user` varchar(15) DEFAULT NULL,
  `insert_date` timestamp NOT NULL DEFAULT current_timestamp(),
...
/*Data for the table `app_promotions_susbscribers` */

insert  into `app_promotions_susbscribers`(`processflag`,`insert_platform`,`insert_user`,`insert_date`,`update_platform`,`update_user`,`update_date`,`delete_platform`,`delete_user`,`delete_date`,`cru_csvnote`,`is_erpsent`,`is_enabled`,`i`,`id`,`code_erp`,`description`,`id_promotion`,`id_promouser`,`date_subs`,`code1`,`date_confirm`,`is_confirmed`,`date_exec`,`notes`,`code_cache`) values (NULL,'1',NULL,'2020-06-30 11:46:23',NULL,NULL,'2020-06-30 11:46:55',NULL,NULL,NULL,NULL,'0','1',NULL,1,NULL,NULL,1,1,'2020-06-30 11:46:55','1waru',NULL,1,NULL,NULL,NULL);
