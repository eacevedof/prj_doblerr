...
class AppPromotionsSubscriptions extends BaseEntity
{
    ...
    /**
     * @var string|null
     * @ORM\Column(name="url_ref", type="string", length=250, nullable=true, options={"default"="NULL"})
     */
    private $urlRef = null;
...
//======================================================================================================================
     ...
     * @return string|null
     */
    public function getUrlRef(): ?string
    {
        return $this->urlRef;
    }

    /**
     * @param string|null $urlRef
     */
    public function setUrlRef(?string $urlRef): void
    {
        $this->urlRef = $urlRef;
    }
